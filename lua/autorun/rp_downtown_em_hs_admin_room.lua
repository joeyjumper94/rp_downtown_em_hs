...
local function func()
	...
	hook.Add("CanPlayerEnterVehicle","_rp_downtown_em_hs_admin",function(ply,vehicle,role)
		if ply and ply:IsValid() and ply:GetPos():WithinAABox(Vector(-3911,94,285),Vector(-3305,5466,561)) then return false
	end end)
...
hook.Add("Initialize","_rp_downtown_em_hs_admin",func)
